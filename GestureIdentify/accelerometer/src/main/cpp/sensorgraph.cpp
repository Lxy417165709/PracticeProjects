...
Java_com_android_accelerometergraph_AccelerometerGraphJNI_get_1x(JNIEnv *env, jclass clazz) {
    // TODO: implement get_x()
    return gSensorGraph.get_x();
}

JNIEXPORT jfloat JNICALL
Java_com_android_accelerometergraph_AccelerometerGraphJNI_get_1y(JNIEnv *env, jclass clazz) {
    // TODO: implement get_y()
    return gSensorGraph.get_y();
}

JNIEXPORT jfloat JNICALL
Java_com_android_accelerometergraph_AccelerometerGraphJNI_get_1z(JNIEnv *env, jclass clazz) {
    // TODO: implement get_y()
    return gSensorGraph.get_z();
}
}
